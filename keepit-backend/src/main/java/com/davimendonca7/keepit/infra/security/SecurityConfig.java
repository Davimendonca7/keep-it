package com.davimendonca7.keepit.infra.security;

import com.davimendonca7.keepit.infra.security.user.UserAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public AuthenticationManager authenticationManager(HttpSecurity http) throws Exception {
        ...
        builder.userDetailsService(userDetailsImplService).passwordEncoder(passwordEncoder());
